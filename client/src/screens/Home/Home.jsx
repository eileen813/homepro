              ...
              <Grid item xs container direction="column" spacing={10}>
                <Grid className="top-paragraph" item xs>
                  <Typography gutterBottom variant="subtitle1" component="div">
                    ...
                    to start home projects, but not finish them?
                  </Typography>
                </Grid>
                ...
                <Grid item xs>
                  <Typography gutterBottom variant="subtitle1" component="div">
                    ...
                    you and your family track your home remodeling projects!
                    Let’s get started! Login or register now to set the stage
                    for your home’s latest and greatest improvements!
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
